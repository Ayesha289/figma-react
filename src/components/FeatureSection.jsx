    ...
    return (
        <section className="pt-8 bg-gray-100">
            <div className="max-w-6xl mx-auto text-center">
                <h2 className="text-2xl font-bold text-red-500 mb-2">Features</h2>
                <h3 className="text-4xl font-bold mb-2">Uifry Premium</h3>
                <div className="grid grid-cols-2 gap-4 mx-4 md:mx-8 lg:mx-12">
                    <div>
                        <FeatureImage imageSrc={featureImage} />
                    </div>
                    <div>
                        <div className="max-w-6xl mx-auto text-left pt-28">
                            <p className="font-bold flex text-left mt-1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                Budgeting Interface</p>
                            <p className="text-left mt-1 mb-4">Cum et convallis risus placerat aliquam, nunc. Scelerisque aliquet faucibus tincidunt eu adipiscing sociis arcu lorem porttitor.</p>
                            <p className="font-bold flex text-left mt-1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            </svg>Customizable Reports</p>
                            <p className="text-left mt-1">Cum et convallis risus placerat aliquam, nunc. Scelerisque aliquet faucibus tincidunt eu adipiscing sociis arcu lorem porttitor.</p>
                        </div>
                    </div>
                </div>
            </div>
